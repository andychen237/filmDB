<!-- Returns top 5 highest-grossing films of a given year -->
<?php
...
if ($stmt = $conn->prepare("CALL TopFiveYear(?)")) {
	...
	if ($result->num_rows == 0) {
	   echo "No revenue information for this year";
	} else {

        //Get each row of result set and push it into table
	    echo "<table border=\"2px solid black\">";
	    echo "<tr><td>Title</td><td>Revenue</td><td>Adjusted_Revenue</td></tr>";
